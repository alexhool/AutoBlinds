...
* **ESP32PCNTEncoder (Custom Library):**
    + A derivative of the ESP32Encoder library by hephaestus, used for reading the motor encoder.
...
* **VL53L0X:**
    + Used for ToF sensor interfacing.
    + Copyright:
...
* **AsyncTCP:**
    + Used for asynchronous TCP communication.
...
* **ESPAsyncWebServer:**
    + Used for running the asynchronous web server.
    + Copyright (C) 2016-2025 Hristo Gochkov, Mathieu Carbou, Emil Muratov
